...
Analysis_01 = open_image('images/Analysis_01.png')
Analysis_02 = open_image('images/Analysis_02.png')
...
def load_dl_model(model_choice):
    ...
    return tensorflow.keras.models.load_model(model_choice)
