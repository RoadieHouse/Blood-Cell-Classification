...
if selected == 'About':
    ...
    st.markdown('''
    Elias Zitterbarth  ([LinkedIn](https://www.linkedin.com/in/elias-zitterbarth) & [GitHub](https://github.com/RoadieHouse))<div style="border-top: 1px dashed #ccc;"></div>
    
    Lilli Krizek  ([LinkedIn](https://www.linkedin.com/in/lilli-krizek-494768226) & [GitHub](https://github.com/Lillioona))<div style="border-top: 1px dashed #ccc;"></div>
    
    Amritha Kalluvettukuzhiyil  ([LinkedIn](www.linkedin.com/in/amritha-k-742b36241) & [GitHub](https://github.com/AmrithaPrasneh))<div style="border-top: 1px dashed #ccc;"></div>
