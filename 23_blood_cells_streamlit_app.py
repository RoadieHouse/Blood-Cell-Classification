...
cell_08 = Image.open('images/M_Plat.jpg')
...
cell_16 = Image.open('images/x.png')
...
if selected == 'E.D.A.':
   ...
   # Create scatterplot with Plotly
    ...
    col8.image(cell_08, use_column_width=True, caption = 'Platlet, Munich')
    ...
    col3.image(cell_03, use_column_width=True, caption = 'IG, Munich')
    col4.image(cell_12, use_column_width=True, caption = 'Lymphocyte, Barcelona')
    col5.image(cell_13, use_column_width=True, caption = 'Monocyte, Barcelona')
    col6.image(cell_14, use_column_width=True, caption = 'Neutrophil, Barcelona')
    col7.image(cell_15, use_column_width=True, caption = 'Lymphocyte, Barcelona')
    col8.image(cell_16, use_column_width=True)
    ...
    col3.image(cell_19, use_column_width=True) 
    col4.image(cell_20, use_column_width=True)
    ...
    col8.image(cell_24, use_column_width=True)
#------------------------------------------------------------------------------------------------------------------------------------------    
#Section Models     
