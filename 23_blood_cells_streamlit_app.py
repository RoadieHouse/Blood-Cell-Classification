...
if selected == 'E.D.A.':
   ...
   # Create scatterplot with Plotly
    ...
    col3.image(cell_12, use_column_width=True, caption = 'IG, Munich')
    col4.image(cell_13, use_column_width=True, caption = 'Lymphocyte, Barcelona')
    col5.image(cell_14, use_column_width=True, caption = 'Monocyte, Barcelona')
    col6.image(cell_15, use_column_width=True, caption = 'Neutrophil, Barcelona')
